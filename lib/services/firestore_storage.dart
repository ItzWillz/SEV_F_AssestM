...
class FirestoreStorage {
  ...
  Future<void> insertAsset(Map<String, dynamic> assetData) async {
    ...
    //     'externalAccessories': 'externalAccessories + $i',
    //     'internalFeatures': 'internalFeatures + $i',
    //     'serialNum': 100 + i,
    //     'status': 'Recycled',
    //     'wirelessNIC': 'wirelessNIC+$i'
    //   };
    // }
    DocumentReference docRef = await db.collection(_assets).add(assetData);
